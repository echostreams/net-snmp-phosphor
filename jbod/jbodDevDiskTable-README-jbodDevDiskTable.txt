...
------------------------------------------------------------------------
  ...
  the jbodDevDiskTable table.  The agent will start by looking for the right
  ...
  file defaults/table-jbodDevDiskTable.m2d, and then re-running mib2c.
    ...
    in the jbodDevDiskTable.h header.
    ...
    will be generated:
      ...
      jbodDevDiskTable_allocate_data
      jbodDevDiskTable_release_data
 ...
 Index(es) for the jbodDevDiskTable table
  ------------------------------------------------------------
  The index(es) for the jbodDevDiskTable table are:
...
************************************************************************
jbodDevDiskTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the jbodDevDiskTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: jbodDevDiskTable_data_access.[c|h]
------------------------------------------------------------------------
  The jbodDevDiskTable_data_access file contains the interface to your data in
  ...
  FUNC : jbodDevDiskTable_indexes_set
  WHERE: jbodDevDiskTable_data_access.c
...
File: jbodDevDiskTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
...
File: jbodDevDiskTable_data_set.c
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      jbodDevDiskTable table.

      Conversely, the examples below may not include some functions that
      were generated for the jbodDevDiskTable table.

To watch the flow of the jbodDevDiskTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        jbodDevDiskTable
        verbose:jbodDevDiskTable
        internal:jbodDevDiskTable

e.g.
        snmpd -f -Le -DjbodDevDiskTable,verbose:jbodDevDiskTable,internal:jbodDevDiskTable
...
/*---------------------------------------------------------------------
 * INWIN-JBOD-MIB::jbodDevDiskEntry.diskIndex
 * diskIndex is subid 1 of jbodDevDiskEntry.
 * Its status is Current, and its access level is NoAccess.
 * OID: .1.3.6.1.4.1.47464.1.2.5.1.1
 * Description:
the disk slot
 *
 * Attributes:
 ...
 *
 *
 * NOTE: NODE diskIndex IS NOT ACCESSIBLE
 *
 *
 */
/*---------------------------------------------------------------------

************************************************************************
jbodDevTemperatureTable README
------------------------------------------------------------------------
  ...
  the jbodDevTemperatureTable table.  The agent will start by looking for the right
  ...
  file defaults/table-jbodDevTemperatureTable.m2d, and then re-running mib2c.
    ...
    in the jbodDevTemperatureTable.h header.
    ...
    will be generated:
      ...
      jbodDevTemperatureTable_allocate_data
      jbodDevTemperatureTable_release_data
 ...
 Index(es) for the jbodDevTemperatureTable table
  ------------------------------------------------------------
  The index(es) for the jbodDevTemperatureTable table are:
...
************************************************************************
jbodDevTemperatureTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the jbodDevTemperatureTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: jbodDevTemperatureTable_data_access.[c|h]
------------------------------------------------------------------------
  The jbodDevTemperatureTable_data_access file contains the interface to your data in
  ...
  FUNC : jbodDevTemperatureTable_indexes_set
  WHERE: jbodDevTemperatureTable_data_access.c
...
File: jbodDevTemperatureTable_enums.h
------------------------------------------------------------------------
...
File: jbodDevTemperatureTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : temperatureDescription_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : temperatureStatus_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : temperatureValue_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : temperatureUnit_get



File: jbodDevTemperatureTable_data_set.c
------------------------------------------------------------------------
...
************************************************************************
jbodDevTemperatureTable Reference
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      jbodDevTemperatureTable table.

      Conversely, the examples below may not include some functions that
      were generated for the jbodDevTemperatureTable table.

To watch the flow of the jbodDevTemperatureTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        jbodDevTemperatureTable
        verbose:jbodDevTemperatureTable
        internal:jbodDevTemperatureTable

e.g.
        snmpd -f -Le -DjbodDevTemperatureTable,verbose:jbodDevTemperatureTable,internal:jbodDevTemperatureTable
...
/*---------------------------------------------------------------------
 * INWIN-JBOD-MIB::jbodDevTemperatureEntry.temperatureIndex
 * temperatureIndex is subid 1 of jbodDevTemperatureEntry.
 * Its status is Current, and its access level is NoAccess.
 * OID: .1.3.6.1.4.1.47464.1.2.2.1.1
 * Description:
 ...
 *
 *
 * NOTE: NODE temperatureIndex IS NOT ACCESSIBLE
 *
 *
 */
/*---------------------------------------------------------------------
